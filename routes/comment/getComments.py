...
@comment.route(f"{Path.TO_DATABASE}/getGJComments21.php", methods=("POST", "GET"))
def get_comment():
    ...
    for i in comments:
        ...
        user_info = tuple(user_db.find({"account_id": account_id}))
        ...
        single_comment_responce = {
            2: base64_decode(i["comment"]), 3: user_info[0]["user_id"],
            4: i["like"], 7: 0, 10: i["percent"], 9: prefix + time_converter(i["upload_time"]),
